...
export class TypeScriptSandbox {
  ...
  getCallEngineFuncByName (name: string): any {
    switch (name) {
    case 'callEngine_i_i':
      return this.callEngine_i_i.bind(this)
    case 'callEngine_i_ii':
      return this.callEngine_i_ii.bind(this)
    case 'callEngine_i_ifff':
      return this.callEngine_i_ifff.bind(this)
    case 'callEngine_i_iffff':
      return this.callEngine_i_iffff.bind(this)
    case 'callEngine_fff_i':
      return this.callEngine_fff_i.bind(this)
    }
  }
